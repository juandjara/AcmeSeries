...
<form:form action="${requestURI}" modelAttribute="producerForm">
<fieldset>
	<legend align="left">
...
<fieldset>
	...
	<acme:datebox code="producer.fundationdate" path="fundationDate"/>
	<acme:urlbox code="producer.webpage" path="webpage"/>
</fieldset>
<br />
